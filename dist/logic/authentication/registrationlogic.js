...
const logic_1 = require("../common/logic");
 ...
 */
class RegistrationLogic extends logic_1.Logic {
    /**
    ...
    validateUserEmail(user, validationCode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let vTokenRepo = this.connection.getCustomRepository(datamodule_1.ValidationTokenRepository);
...
exports.RegistrationLogic = RegistrationLogic;

//# sourceMappingURL=registrationlogic.js.map
