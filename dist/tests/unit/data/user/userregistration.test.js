...
describe('UserRegistration', () => {
    ...
    test('Constructor parameter username works.', () => {
        let registration = new models_1.UserRegistration('Bert');
    ...
    test('Constructor parameter password works.', () => {
        let registration = new models_1.UserRegistration('Bert', 'password');
    ...
    test('Constructor parameter name works.', () => {
        let registration = new models_1.UserRegistration('Bert', 'password', 'Bert P');
    ...
    test('Constructor parameter email works.', () => {
        let registration = new models_1.UserRegistration('Bert', 'password', 'Bert P', 'Email@domain.com');
