 ...
 */
class MockUserService extends service_1.Service {
    constructor() {
        super(...arguments);
...
describe('ServiceLocator', () => {
    ...
    describe('clear()', () => {
        it('clears out any existing services with the locator', () => {
            servicelocator_1.ServiceLocator.services.push(new MockUserService(null));
            servicelocator_1.ServiceLocator.clear();
    ...
    describe('register()', () => {
        ...
        it('registers a service with the locator', () => {
            let mockService = new MockUserService(null);
